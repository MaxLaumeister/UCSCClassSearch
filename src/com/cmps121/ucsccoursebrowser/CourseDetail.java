...
public class CourseDetail extends Course {
	...
	public CourseDetail(String title, String time, String instructor, String status,
			int capacity, int enrollment_total, int available_seats, int credits, String type,
			int wait_list_capacity, int wait_list_total, String genEds, String description) {
		
		super(title, time, instructor, status,
				capacity, enrollment_total, available_seats, type, credits);
